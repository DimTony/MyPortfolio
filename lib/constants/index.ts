...
import { NavItem, SocialLink, TechIcon, Slide, Testimonial } from "@/types";
...
export const bentoSocialLinks: SocialLink[] = [
  {
    name: "Facebook",
...
export const iconsList: TechIcon[] = [
  {
    name: "html",
...
export const footerIconsList: SocialLink[] = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/",
